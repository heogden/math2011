...
occuring in a time interval of length $t$ has $\text{Poisson}(\beta t)$
...
$M_Y(t) = (1 - t/\beta)^{-\alpha}$, the the cgf is
...
```{proof}
Wite $\Phi(.)$ for the cumulative distribution function of $Z$,
...
a supply of independent and indentically distributed standard normal
random variables:
