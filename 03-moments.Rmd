...
Similarly, we define the fourth moment about the mean
...
These quantities are unchanged by linear transformations of $Y$.
[**TODO: add further justification, or link to exercise**]
...
```{example, homexp, name = "Skewness and kurtosis of the Exponential distribution"}
...
\end{align*}
 ...
 are highly positively skewed ($\gamma_1 = 2$), with a high
 kurtosis ($\gamma_2 = 4$).
```

**TODO: add skewness and kurtosis of normal distribution, for comparison**?
